...
[DependsOn(typeof(PlatformAdministrationServiceTestBaseModule))]
[DependsOn(typeof(PlatformAdministrationServiceEntityFrameworkCoreModule))]
public class PlatformAdministrationServiceEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var context = new AdministrationServiceDbContext(options);

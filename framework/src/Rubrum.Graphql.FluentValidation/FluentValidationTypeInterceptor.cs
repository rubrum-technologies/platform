...
using Rubrum.Graphql.Extensions;
...
public class FluentValidationTypeInterceptor : TypeInterceptor
{
        ...
        IValidator validator)
    {
        ...
        var localizer = completionContext.Services
            .GetRequiredService<IStringLocalizer<RubrumGraphqlFluentValidationResource>>();
    ...
    private static string GetDescription(
        ...
        IStringLocalizer<RubrumGraphqlFluentValidationResource> localizer)
    {
